...
const { signup, logout, recaptchaChecking, login, sendCodeGet, sendCodePost, varifyCode, varifyCodeRecover, recoverPass, editPass, adminAdd } = require("../controller/user.controller");
